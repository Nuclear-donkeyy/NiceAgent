...
- 真实 Grafana 导入、值班系统接入和更细审计；Runtime rate limit denial metric、Prometheus 告警样例、Alertmanager 路由、容量/排障 runbook 和 dashboard JSON 样例已有最小版本。
