...
- 生产级 Grafana 容量看板和更细审计；Runtime rate limit denial metric、Prometheus 告警样例、Alertmanager 路由和容量/排障 runbook 已有最小版本。
