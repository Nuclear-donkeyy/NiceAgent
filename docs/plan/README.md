...
2. Skill 治理补强：在已有 HTTP Skill schema validation、错误模型、secret redaction、OpenAPI preview/save、per-skill retry、进程内/Redis 跨副本 rate limit 基础上，继续补 MCP 导入预留和更细审计。
