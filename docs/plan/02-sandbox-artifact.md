...
- Sandbox Executor 已能扫描 output 目录并生成 artifact metadata；Runtime 已能在 sandbox tool 调用后增量登记 artifacts；前端已支持图片、PDF、音频、视频和 CSV/TSV 表格预览；后续补更多文件类型预览、过期清理和对象存储归档。
