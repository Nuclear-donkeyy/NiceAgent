...
3. 邀请邮件 subject/body 模板、进程内内存队列、durable outbox、邀请邮件重发 API、provider-neutral 退信事件记录、HMAC webhook 入口、SendGrid/SES/Mailgun 最小原生字段映射、组织级自动停发、suppression 查询/解除 API 和前端“邮件治理”管理面板已落地；下一步补服务商原生签名校验和更细 action policy，让邀请流程从最小闭环走向可运营。
