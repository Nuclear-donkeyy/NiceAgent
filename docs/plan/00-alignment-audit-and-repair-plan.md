...
3. 邀请邮件 subject/body 模板、进程内内存队列和 durable outbox 已落地；下一步补退信处理，让邀请流程从最小闭环走向可运营。
