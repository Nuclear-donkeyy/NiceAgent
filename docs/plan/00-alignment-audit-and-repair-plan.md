...
3. 邀请邮件 subject/body 模板、进程内内存队列、durable outbox、邀请邮件重发 API 和 provider-neutral 退信事件记录已落地；下一步补服务商原生字段映射和自动停发策略，让邀请流程从最小闭环走向可运营。
