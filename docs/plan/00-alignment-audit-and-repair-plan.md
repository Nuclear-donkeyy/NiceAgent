...
3. 邀请邮件 subject/body 模板、进程内内存队列、durable outbox、邀请邮件重发 API、provider-neutral 退信事件记录和组织级自动停发已落地；下一步补服务商原生字段映射、suppression 解除/管理 UI 和更细 action policy，让邀请流程从最小闭环走向可运营。
